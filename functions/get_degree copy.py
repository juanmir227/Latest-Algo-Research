...
for init_block in initial_number:
    with open(r'D:\Archivos de Programa\Carpetas\Coding\Algorand\Tesis\Tesis\periodo1_data_frame\df_'+ str(init_block)+"_"+str(number_of_blocks)+'_filtered', 'rb') as fp:
        df = pickle.load(fp)
