...
graphs.append(G)
with open(r'D:\Archivos de Programa\Carpetas\Coding\Algorand\Tesis\Tesis\filtering_algorithm\periodo3_dataframe\periodo3_'+ str(22800000)+"_"+str(number_of_blocks), 'rb') as fp:
    data = pickle.load(fp)
